...
function Skills() {
  return (
    <div
      id="skills"
      className="py-24 pt-16 bg-gradient-to-br from-[#0f0f3d] via-[#1a0f4d] to-[#03001e] text-white px-6 flex items-center justify-center relative overflow-hidden"
    >
      ...
      <div className="max-w-5xl w-full relative z-10 text-center space-y-10">
        <div>
          <h2 className="text-5xl lg:text-6xl font-bold mb-4 bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text text-transparent font-sans">
            Skills
          </h2>
