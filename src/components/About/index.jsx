...
function About() {
  ...
  return (
    <div className="min-h-[130vh] pt-20 pb-20 bg-gradient-to-br from-[#0f0f3d] via-[#1a0f4d] to-[#03001e] text-white px-6 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-6xl w-full flex flex-col lg:grid lg:grid-cols-2 gap-12 items-center relative z-10">
  ...
  <div>
    ...
    <div className="w-24 h-1 bg-gradient-to-r from-purple-400 to-pink-400 mx-auto lg:mx-0 mb-6"></div>
          ...
          <p className="text-gray-300 text-lg lg:text-xl font-medium leading-relaxed">
            ...
            responsive interfaces, and user-centered development.
          ...
          <p className="text-gray-300 text-lg lg:text-xl font-medium leading-relaxed">
            ...
            <Rocket className="text-2xl text-purple-400 mb-2" aria-hidden="true" focusable="false"/>

              <span className="text-sm text-gray-300 font-medium">Fast & Modern</span>
            </div>

            <div className="flex flex-col items-center p-4 bg-white/5 rounded-lg backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300">
              <Palette className="text-2xl text-pink-400 mb-2" aria-hidden="true" focusable="false"/> 
              <span className="text-sm text-gray-300 font-medium">Clean Design</span>
            </div>
            
            <div className="flex flex-col items-center p-4 bg-white/5 rounded-lg backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300">
              <Users className="text-2xl text-blue-400 mb-2" aria-hidden="true" focusable="false" />
  ...
  src={profileImg}
  alt="Portrait of me"
  className="relative mx-auto rounded-full w-28 h-28 sm:w-32 sm:h-32 md:w-36 md:h-36 border-4 border-white/30 shadow-xl"
/>
</div>
          


  <h3 className="text-3xl font-bold mb-2 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent"> Hazel </h3>
    <p className="text-gray-400 mb-6 text-lg">Frontend Developer</p>
          ...
          <div className="flex items-start space-x-3 p-3 rounded-lg bg-white/5 hover:bg-white/10 transition-all duration-300">
          <Code className="text-blue-400 mt-1 flex-shrink-0" /> <div>
          <p className="text-gray-200 font-medium">Lifelong Learner</p>
          <p className="text-gray-400 text-sm">Continuously improving through self-study, hands-on projects, and curiosity-driven learning </p>
          </div>
          </div>
