      ...
      <div className="max-w-6xl w-full relative z-10">
        <div className="text-center mb-20">
          ...
          <p className="text-gray-300 text-lg lg:text-xl font-medium leading-relaxed max-w-3xl mx-auto">
            ...
            <span className="text-purple-300 font-medium">
              Clean, responsive and user-focused.
            </span>
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {projects.map((project, index) => (
            <div
              key={index}
              className="group relative bg-white/5 backdrop-blur-lg rounded-3xl p-6 border border-white/10 hover:border-purple-400/30 transition-all duration-500 shadow-2xl hover:shadow-purple-500/20 hover:bg-white/10 transform hover:-translate-y-2"
            >
