...
function Hero() {
  ...
  I craft intuitive and elegant web interfaces with clean code and creative design.
        ...
        <div className="flex justify-center gap-4 mt-6 flex-wrap">
          <a href="#projects" className="bg-black text-white hover:bg-gray-800 px-6 py-2 rounded-lg shadow">
            Projects ↗
          </a>
          <a href="#contact" className="bg-gray-700 hover:bg-gray-600 px-6 py-2 rounded-lg">
            Contact ✉️
          </a>
        </div>
