      ...
      <div className="w-full max-w-2xl bg-white/5 backdrop-blur-md border border-purple-500/10 rounded-2xl p-10 shadow-2xl z-10 space-y-8 relative">
        ...
        {status && (
          <div 
            role="alert"
            aria-live="polite"
            className={`absolute -top-4 left-1/2 transform -translate-x-1/2 px-6 py-3 rounded-lg shadow-lg backdrop-blur-md border transition-all duration-500 ${
              status === 'success' 
        ...
        <form ref={form} onSubmit={sendEmail} className="space-y-6">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold py-4 rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed relative overflow-hidden group focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 focus:ring-offset-[#0f0f3d]"
          >
            {isLoading ? (
              ...
              <>
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-pink-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300" aria-hidden="true"></div>
              </>
            )}
          </button>
          <div id="submit-description" className="sr-only">
            Click to send your message. You will receive a confirmation when the message is sent successfully.
          </div>
        </form>
        ...
        <div className="text-center space-y-6 pt-4 border-t border-white/10">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 bg-white/10 text-white px-6 py-3 rounded-lg hover:bg-white/20 transition-all duration-300 transform hover:scale-105 border border-transparent hover:border-purple-500/30 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 focus:ring-offset-[#0f0f3d]"
              aria-label="Send email to hazelhmurcu@live.de"
            >
          ...
          <div className="flex justify-center gap-6">
            <a
              ...
              aria-label="Visit Hazel's GitHub profile (opens in new tab)"
              className="group p-3 rounded-full bg-white/10 hover:bg-white/20 transition-all duration-300 transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 focus:ring-offset-[#0f0f3d]"
            >
              <FaGithub className="text-2xl text-white/70 group-hover:text-white transition-colors duration-300" aria-hidden="true" />
            </a>
            <a
              href="https://www.linkedin.com/in/hazel-hamurcu"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Visit Hazel's LinkedIn profile (opens in new tab)"
              className="group p-3 rounded-full bg-white/10 hover:bg-white/20 transition-all duration-300 transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 focus:ring-offset-[#0f0f3d]"
            >
              <FaLinkedin className="text-2xl text-white/70 group-hover:text-white transition-colors duration-300" aria-hidden="true" />
            </a>
          </div>
        </div>
      </div>
